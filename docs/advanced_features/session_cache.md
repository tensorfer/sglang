...
- The upcoming turn will generate tokens [213, 1213) (as maxium as 1213), and the associated KV cache will be saved locally at `/session-97f1226c-e752-4961-a858-432814b5dce0`.
### Supported storage backend
- **Local file**: A simple file-based storage backend for demonstration purposes.
- **GD2FS**: GPU Direct Distributed File System is a high-performance distributed file system for LLM. Try GD2FS [here](https://github.com/sgl-project/sglang/tree/main/python/sglang/srt/mem_cache/storage/gd2fs).
### Advanced features
